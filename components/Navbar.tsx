...
const Navbar = ({openNav}: Props) => {
  ...
  return (
    <nav className={`w-[100%] fixed z-[100000] min-h-[12vh] top-0 pb-3 flex items-end h-[50px] transition-all duration-500 ease-in-out bg-slate-950 ${scrollNav ? 'pb-6 bg-opacity-60 backdrop-blur-lg backdrop-brightness-100' : 'bg-opacity-0 backdrop-blur-none'}`}>
