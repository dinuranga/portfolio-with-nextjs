...
const Contact = () => {
    return (
        <div id="contact" className="scroll-mt-[12vh] pt-[4rem] md:pt-[6rem] pb-[4rem] md:pb-[4rem] bg-slate-950">
            <div className="w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2">
                <div className="w-[80%]">
                    ...
                    <h1 className='min-h-[8rem] md:min-h-[7rem] text-[25px] lg:text-[50px] text-secondary font-secondary font-bold'>
